This is simple project to detect human frontal faces in images or videos live and draws a box around them. It uses Haar-Cascades from OpenCV so to run the programs you need to download OpenCV.
